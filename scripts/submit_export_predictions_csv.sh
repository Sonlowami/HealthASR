...
SLURM_JOB_NAME="${SLURM_JOB_NAME:-whisper-pred-csv}"
...
#SBATCH -o ${RUN_ROOT}/export_%j.log
...
python training/whisper/export_predictions_csv.py ${PY_ARGS_STR}
EOF
